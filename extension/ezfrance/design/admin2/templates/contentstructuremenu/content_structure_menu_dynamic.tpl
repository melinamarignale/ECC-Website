    ...
    this.classes = {*
        *}{ldelim}{*
            *}{foreach fetch('class','list') as $class}{*
                *}"{$class.id}":{ldelim}name:"<span class='eziconize'>{$class.identifier|class_icon('small')|wash}</span>&nbsp;{$class.name|wash(javascript)}",identifier:"{$class.identifier|wash(javascript)}"{rdelim}{*
                *}{delimiter},{/delimiter}{*
            *}{/foreach}{*
        *}{rdelim};
